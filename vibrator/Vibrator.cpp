...
static constexpr uint32_t WAVEFORM_MAX_DURATION_MS = 150;
...
ndk::ScopedAStatus Vibrator::on(int32_t timeoutMs,
    ...
    // Reset duration to maximum if it exceeds maximum duration
    if (timeoutMs > WAVEFORM_MAX_DURATION_MS) {
        timeoutMs = WAVEFORM_MAX_DURATION_MS;
    }
