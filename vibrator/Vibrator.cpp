...
ndk::ScopedAStatus Vibrator::perform(Effect effect, EffectStrength strength,
    ...
    switch (effect) {
        case Effect::TICK:
            ...
            write_node(index_node, WAVEFORM_TICK_EFFECT_INDEX);
            write_node(control_node, LOW_WAVEFORM_OFFSET);
            timeMs = WAVEFORM_TICK_EFFECT_MS;
            write_node(duration_node, WAVEFORM_TICK_EFFECT_MS);
            break;
        case Effect::TEXTURE_TICK:
            LOG(INFO) << "Vibrator effect set to TEXTURE_TICK";
            write_node(index_node, WAVEFORM_CLICK_EFFECT_INDEX);
            write_node(control_node, LOW_WAVEFORM_OFFSET);
            timeMs = WAVEFORM_TEXTURE_TICK_EFFECT_MS;
            write_node(duration_node, WAVEFORM_TEXTURE_TICK_EFFECT_MS);
            break;
        case Effect::CLICK:
            ...
            write_node(duration_node, WAVEFORM_CLICK_EFFECT_MS);
            break;
        case Effect::HEAVY_CLICK:
            LOG(INFO) << "Vibrator effect set to HEAVY_CLICK";
            write_node(index_node, WAVEFORM_HEAVY_CLICK_EFFECT_INDEX);
            write_node(control_node, MID_WAVEFORM_OFFSET);
            timeMs = WAVEFORM_HEAVY_CLICK_EFFECT_MS;
            write_node(duration_node, WAVEFORM_HEAVY_CLICK_EFFECT_MS);
            break;
        case Effect::DOUBLE_CLICK:
            LOG(INFO) << "Vibrator effect set to DOUBLE_CLICK";
            write_node(index_node, WAVEFORM_DOUBLE_CLICK_EFFECT_INDEX);
            write_node(control_node, MID_WAVEFORM_OFFSET);
            write_node(duration_node, WAVEFORM_DOUBLE_CLICK_EFFECT_MS_PHASE_1);
            send_node(WAVEFORM_DOUBLE_CLICK_EFFECT_MS_PHASE_1);
            usleep(100);
            send_node(0);
            write_node(index_node, WAVEFORM_DOUBLE_CLICK_EFFECT_INDEX);
            write_node(control_node, MID_WAVEFORM_OFFSET);
            timeMs = WAVEFORM_DOUBLE_CLICK_EFFECT_MS_PHASE_2;
            write_node(duration_node, WAVEFORM_DOUBLE_CLICK_EFFECT_MS_PHASE_2);
            break;
        case Effect::THUD:
            LOG(INFO) << "Vibrator effect set to THUD";
            write_node(index_node, WAVEFORM_THUD_EFFECT_INDEX);
            write_node(control_node, HIGH_WAVEFORM_OFFSET);
            timeMs = WAVEFORM_THUD_EFFECT_MS;
            write_node(duration_node, WAVEFORM_THUD_EFFECT_MS);
            break;
        case Effect::POP:
            ...
            write_node(duration_node, WAVEFORM_POP_EFFECT_MS);
            break;
        default:
